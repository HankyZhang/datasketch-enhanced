...
def main():
    ...
    header = [
        'dataset_size','n_queries','k','k_children','n_probe','method',
        'recall@k','avg_query_time','base_build_time','parent_extraction_time','mapping_build_time',
        'avg_candidate_size','coverage_fraction','parent_count','covered_points','total_points','query_sampled','timestamp'
    ]
            ...
            for n_probe in n_probe_list:
                ...
                for method in mapping_methods:
                    ...
                    try:
                        ...
                        index.build_parent_child_mapping(method=method)
